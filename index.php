...
<script>
    (function() {
        ...
        (function buildPalette() {
            for (let i = 0; i < 64; i++) {
                ...
                if (t < 0.05) {
                    ...
                    const k = (t - 0.40) / 0.22;
                    r = 255;
                    g = Math.round(40 + 140 * k);
                    b = 0;
                    a = 255;
                } else if (t < 0.82) {
                    const k = (t - 0.62) / 0.20;
                    r = 255;
                    g = Math.round(180 + 60 * k);
                    b = Math.round(20 * k);
                    a = 255;
                } else {
                    const k = (t - 0.82) / 0.18;
                    r = 255;
                    g = Math.round(240 + 15 * k);
                    b = Math.round(20 + 235 * k);
                    a = 255;
                }
                PAL[i * 4] = r;
                PAL[i * 4 + 1] = g;
        ...
        window.addEventListener('scroll', computeShift, {
            passive: true
        });
...
<body>
   ...
   ───────────────────────────────────────────────────────────────────────────── */
    ...
    <script>
        (function() {
            ...
            banner.addEventListener('touchstart', onPointerDown, {
                passive: false
            });
    ...
    <div id="telegram-banner" class="telegram-banner" data-collapsed="false">
        <div class="tg-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-brand-telegram">
   ...
   ============================================================================= */
            ...
            .quick-access-container {
                ...
                z-index: 10000;
                width: 48px;
                /* по кнопке: панель висит абсолютом и ширину не задаёт */
            }
   ...
   включая ступеньки. box-shadow с clip-path так не умеет. */
            .quick-menu-card {
                ...
                clip-path: polygon(0 8px, 4px 8px, 4px 4px, 8px 4px, 8px 0, calc(100% - 8px) 0, calc(100% - 8px) 4px,
