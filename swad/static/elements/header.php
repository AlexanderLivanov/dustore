...
const pagesTopics = {
    ...
    '/l4t': {
        ...
        topics: [
            { label: "Как найти команду для проекта?", answer: "Создай объявление о поиске — опиши, кто нужен (художник, программист, композитор). Или просмотри резюме других пользователей.", emotion: 'happy' },
            { label: "Как предложить свои услуги?", answer: "Заполни свой профиль в L4T: укажи навыки, опыт и желаемую роль. Студии сами смогут тебя найти!", emotion: 'normal' },
            { label: "Как нанять человека в студию?", answer: "На странице студии есть кнопка «Нанять». Ты можешь создать вакансию и собирать отклики от соискателей.", emotion: 'think' },
            { label: "Как откликнуться на заказ?", answer: "Нажимай «Откликнуться» на интересном предложении и пиши, почему ты подходишь. Не стесняйся, мы все здесь свои!" }
        ]
    },
    '/assetstore': {
        greetings: [
        ...
        topics: [
            { label: "Как купить ассет?", answer: "Выбери понравившийся ассет и нажми «Купить». Оплата через FinV2, и файл сразу у тебя. Всё просто!", emotion: 'happy' },
            { label: "Как продать свой ассет?", answer: "Нажми «Загрузить ассет», заполни описание, укажи цену и отправь на проверку. После одобрения он появится в магазине.", emotion: 'think' },
            { label: "Какие форматы поддерживаются?", answer: "Картинки, звуки, 3D-модели, даже готовые скрипты. Главное — чтобы лицензия позволяла перепродажу." },
            { label: "Можно ли вернуть ассет?", answer: "Если ассет не соответствует описанию, напиши в поддержку через «Битый Пиксель». Мы разберёмся." }
        ]
    },
    '/player': {
        greetings: [
        ...
        topics: [
            { label: "Как изменить аватар?", answer: "Нажми на текущий аватар и загрузи новый. Картинка должна быть квадратной и не слишком тяжёлой.", emotion: 'normal' },
            { label: "Где посмотреть мои достижения?", answer: "В разделе «Достижения» собраны все твои награды. Чем активнее ты на платформе, тем их больше!", emotion: 'happy' },
            { label: "Как изменить настройки профиля?", answer: "Нажми на шестерёнку или «Редактировать профиль». Там можно поменять имя, описание и приватность.", emotion: 'think' },
            { label: "Как посмотреть мои отзывы?", answer: "На вкладке «Отзывы» видны все оценки и комментарии от других игроков и разработчиков." }
        ]
    },
    '/g': {
        greetings: [
        ...
        topics: [
            { label: "Как скачать эту игру?", answer: "Нажми большую кнопку «Скачать». Если игра платная, сначала оплати через FinV2. Нулевая комиссия для тебя!", emotion: 'happy' },
            { label: "Как оставить отзыв?", answer: "Прокрути вниз до блока «Отзывы» и поставь оценку. Можешь написать подробный фидбек — разработчики будут рады." },
            { label: "Что значит «Название студии»?", answer: "Это студия-разработчик. Нажми на название, чтобы посмотреть все её игры и контакты." },
            { label: "Игра не запускается, что делать?", answer: "Проверь системные требования в описании. Если всё совпадает, нажми «Пожаловаться» или напиши в «Битый Пиксель».", emotion: 'think' }
        ]
    },
    '/jams': {
        greetings: [
            "Ты в разделе спринтов! Это как джемы, только с чёткими сроками.",
            "Спринты — отличный способ прокачать навыки и выиграть призы. Что интересует?",
            "Привет! Готов поучаствовать в соревновании по разработке?"
        ],
        topics: [
            { label: "Что такое спринт?", answer: "Спринт — это ограниченное по времени соревнование, где команды или одиночные разработчики создают игру на заданную тему. Победители получают призы и признание сообщества.", emotion: 'happy' },
            { label: "Как принять участие в спринте?", answer: "На странице спринтов выбери активный спринт и нажми «Участвовать». Если нужна команда — воспользуйся L4T (биржей команд).", emotion: 'normal' },
            { label: "Как создать свой спринт?", answer: "Нажми «Создать спринт» в правом верхнем углу. Укажи название, описание, тему, дату старта, длительность и призы. После модерации он станет доступен для всех." },
            { label: "Есть ли призы в спринтах?", answer: "Да, организатор может установить денежные или нематериальные призы для победителей. Также спринт даёт очки рейтинга и достижения." }
        ]
    },
    '/about': {
        greetings: [
            "Ты на странице «О нас». Хочешь узнать, кто мы и зачем мы здесь?",
            "Привет! Мы — команда Dustore, и мы расскажем, что нас вдохновляет.",
            "Добро пожаловать на страницу нашей миссии. Чем могу помочь?"
        ],
        topics: [
            { label: "Кто создал Dustore?", answer: "Dustore создан командой энтузиастов-разработчиков, которые сами являются инди-разработчиками и знают проблемы отрасли изнутри." },
            { label: "В чём миссия Dustore?", answer: "Мы хотим дать инди-разработчикам свободу публикации игр без грабительских комиссий, а игрокам — доступ к уникальным проектам.", emotion: 'think' },
            { label: "Сколько лет платформе?", answer: "Платформа запущена в 2025 году и активно развивается. Мы постоянно добавляем новые функции." },
            { label: "Где я могу найти команду?", answer: "На странице L4T (Looking for a Team) — там собираются все, кто ищет союзников для проектов." }
        ]
    },
    '/brokenpixel': {
        greetings: [
            "Ты в «Битом Пикселе» — месте, где мы ловим баги и уязвимости.",
            "Привет! Если нашёл ошибку или дыру в безопасности, смело пиши.",
            "Битый Пиксель — наш центр по приёму баг-репортов. Что случилось?"
        ],
        topics: [
            { label: "Как сообщить о баге?", answer: "Заполни форму на странице «Битый Пиксель»: опиши проблему, приложи скриншот или видео. Мы постараемся исправить как можно быстрее." },
            { label: "Что такое программа баг-баунти?", answer: "Мы поощряем исследователей безопасности за найденные уязвимости — можно получить денежное вознаграждение или статус на платформе.", emotion: 'happy' },
            { label: "Кто обрабатывает отчёты?", answer: "Наша команда модерации и разработчики. Мы ценим вашу помощь и всегда отвечаем на каждый отчёт." }
        ]
    },
    '/media': {
        greetings: [
            "Ты в Медиа — нашем блоге и новостной ленте.",
            "Привет! Здесь свежие статьи, новости и анонсы от команды Dustore.",
            "Хочешь быть в курсе всего? Тогда ты по адресу."
        ],
        topics: [
            { label: "Что публикуется в Медиа?", answer: "Новости платформы, анонсы спринтов, интервью с разработчиками, гайды по созданию игр и многое другое.", emotion: 'happy' },
            { label: "Могу ли я предложить свою статью?", answer: "Да, мы открыты к сотрудничеству с сообществом. Напиши нам через «Битый Пиксель» или в соцсетях.", emotion: 'think' },
            { label: "Где я могу следить за новостями?", answer: "Подписывайся на наш Telegram-канал и VK-сообщество. Все ссылки есть на главной странице." }
        ]
    },
    '/gddb': {
        greetings: [
            "Ты в GDDB — базе знаний для разработчиков!",
            "Привет! Тут собраны статьи, уроки и ссылки по геймдеву.",
            "Ищешь ответ на вопрос по разработке? Спроси меня."
        ],
        topics: [
            { label: "Что такое GDDB?", answer: "GDDB (GameDev DataBase) — это открытая база знаний, где каждый может добавлять статьи, гайды и ссылки на полезные ресурсы для разработчиков.", emotion: 'think' },
            { label: "Как добавить свою статью?", answer: "Зарегистрируйся и в разделе GDDB нажми «Добавить статью». После модерации она появится на сайте." },
            { label: "Какие темы охватывает GDDB?", answer: "Программирование, гейм-дизайн, 2D/3D-графика, звук, сценарии, монетизация — всё, что может пригодиться инди-разработчику." }
        ]
    },
    '/notifications': {
        greetings: [
            "Твои уведомления. Новые сообщения, события и обновления.",
            "Привет! Проверь, что нового на Dustore.",
            "Тут собраны все твои оповещения. Что-то пропустил?"
        ],
        topics: [
            { label: "Какие уведомления я получаю?", answer: "Новые сообщения в чатах, обновления статуса спринтов, ответы на твои отзывы, комментарии и многое другое." },
            { label: "Можно ли отключить уведомления?", answer: "Да, в настройках профиля ты можешь управлять типами уведомлений, которые хочешь получать.", emotion: 'normal' },
            { label: "Почему я получаю уведомление от платформы?", answer: "Платформа уведомляет тебя о важных событиях: выходе новых игр, начале спринтов, личных сообщениях и т. д." }
        ]
    },
    '/stat': {
        greetings: [
            "Ты на странице статистики Dustore.",
            "Привет! Смотри цифры — игры, пользователи, спринты.",
            "Хочешь увидеть, как растёт платформа? Держи данные!"
        ],
        topics: [
            { label: "Какая статистика доступна?", answer: "Количество игр, студий, пользователей, спринтов, а также динамика роста за разные периоды." },
            { label: "Обновляется ли статистика в реальном времени?", answer: "Да, большинство показателей обновляются ежедневно, а онлайн-счётчик — в реальном времени.", emotion: 'happy' },
            { label: "Где я могу увидеть детальную статистику по моей игре?", answer: "Для разработчиков детальная аналитика доступна в консоли разработчика — там есть графики и отчёты." }
        ]
    },
    '_default': {
        greetings: [
